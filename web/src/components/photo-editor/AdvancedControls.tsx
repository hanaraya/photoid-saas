      ...
      <summary className="flex items-center justify-between p-4 cursor-pointer hover:bg-muted/30 transition-colors list-none">
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            ...
            <div className="text-xs text-muted-foreground">Zoom & brightness controls</div>
          </div>
        </div>
        <svg
      ...
      <div className="border-t border-border/50 p-4 space-y-4">
        <div className="space-y-2">
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="font-mono text-xs bg-muted/50 px-2 py-0.5 rounded">{zoom}%</span>
          </div>
          <Slider
            value={[zoom]}
            min={50}
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="font-mono text-xs bg-muted/50 px-2 py-0.5 rounded">{brightness}%</span>
          </div>
          <Slider
            value={[brightness]}
            min={50}
