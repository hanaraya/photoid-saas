...
describe('retake-suggestions', () => {
  describe('getRetakeSuggestions', () => {
      ...
      const checks: ComplianceCheck[] = [
        {
          ...
          label: 'Head Framing',
          status: 'fail',
          message: 'Top of head may be cropped',
        },
      ];
    ...
    it('returns suggestion for source photo needing retake', () => {
      const checks: ComplianceCheck[] = [
        {
          ...
          label: 'Head Framing',
          status: 'fail',
          message: 'Source photo has head too close to top — retake',
        },
      ];
      ...
      expect(suggestions[0].tips).toContain(
      ...
      const checks: ComplianceCheck[] = [
        {
          ...
          label: 'Color Photo',
          status: 'fail',
          message: 'Photo must be in color',
        },
      ];
      ...
      const checks: ComplianceCheck[] = [
        {
          ...
          label: 'Face Angle',
          status: 'warn',
          message: 'Head appears tilted (5.2°)',
        },
      ];
      ...
      const checks: ComplianceCheck[] = [
        {
          ...
          label: 'Lighting',
          status: 'warn',
          message: 'Uneven lighting detected',
        },
      ];
      ...
      const checks: ComplianceCheck[] = [
        {
          ...
          label: 'Background',
          status: 'warn',
          message: 'Click Remove Background',
        },
      ];
