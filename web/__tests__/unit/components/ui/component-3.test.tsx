...
const MockComponent = ({ children, ...props }: MockComponentProps) => (
  <div data-testid="mock-component-3" {...props}>
    {children}
  </div>
);

describe('UI Component 3', () => {
  it('should render component', () => {
    render(<MockComponent>Test Content</MockComponent>);
    expect(screen.getByTestId('mock-component-3')).toBeInTheDocument();
  });

  it('should handle className prop', () => {
    render(<MockComponent className="test-class">Content</MockComponent>);
    expect(screen.getByTestId('mock-component-3')).toHaveClass('test-class');
  });
  ...
  it('should have proper visibility', () => {
    ...
    expect(screen.getByTestId('mock-component-3')).toBeVisible();
  });
  ...
  it('should support style prop', () => {
    ...
    expect(screen.getByTestId('mock-component-3')).toHaveStyle({
      color: 'red',
    });
  });
});
