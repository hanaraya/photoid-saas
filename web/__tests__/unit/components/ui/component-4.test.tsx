...
const MockComponent = ({ children, ...props }: MockComponentProps) => (
  <div data-testid="mock-component-4" {...props}>
    {children}
  </div>
);

describe('UI Component 4', () => {
  it('should render component', () => {
    render(<MockComponent>Test Content</MockComponent>);
    expect(screen.getByTestId('mock-component-4')).toBeInTheDocument();
  });

  it('should handle className prop', () => {
    render(<MockComponent className="test-class">Content</MockComponent>);
    expect(screen.getByTestId('mock-component-4')).toHaveClass('test-class');
  });
  ...
  it('should have proper visibility', () => {
    ...
    expect(screen.getByTestId('mock-component-4')).toBeVisible();
  });
  ...
  it('should support style prop', () => {
    ...
    expect(screen.getByTestId('mock-component-4')).toHaveStyle({
      color: 'red',
    });
  });
});
