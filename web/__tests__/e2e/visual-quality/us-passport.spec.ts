...
const SCREENSHOT_DIR = path.join(
  __dirname,
  '../../../test-results/screenshots/us-passport'
);
...
test.describe('US Passport Photo - Complete E2E Flow', () => {
  ...
  test('should display correct US passport specifications', async ({
    page,
  }) => {
    ...
    await expect(
      page
        .locator('text=white background')
        .or(page.locator('text=White background'))
        .first()
    ).toBeVisible();
  ...
  test('should show glasses policy warning for US photos', async ({ page }) => {
    ...
    const hasGlassesPolicy = await page
      .locator('text=Glasses')
      .or(page.locator('text=glasses'))
      .isVisible();
  ...
  test('should trigger background removal for colored background', async ({
    page,
  }) => {
    // Use a photo with colored background
    const coloredBgPhoto = path.join(
      __dirname,
      '../../fixtures/quality-tests/bad-dark-background.jpg'
    );
...
test.describe('US Passport Photo - Visual Quality Verification', () => {
  ...
  test('should detect low resolution photos', async ({ page }) => {
    const lowResPhoto = path.join(
      __dirname,
      '../../fixtures/quality-tests/bad-low-resolution.jpg'
    );
  ...
  test('should detect off-center faces', async ({ page }) => {
    const offCenterPhoto = path.join(
      __dirname,
      '../../fixtures/quality-tests/bad-off-center.jpg'
    );
  ...
  test('should detect overexposed photos', async ({ page }) => {
    const overexposedPhoto = path.join(
      __dirname,
      '../../fixtures/quality-tests/bad-overexposed.jpg'
    );
  ...
  test('should detect underexposed photos', async ({ page }) => {
    const underexposedPhoto = path.join(
      __dirname,
      '../../fixtures/quality-tests/bad-underexposed.jpg'
    );
...
test.describe('US Passport Photo - Output Quality Analysis', () => {
  ...
  test('should produce correctly sized US output (600x600)', async ({
    page,
  }) => {
    const testPhoto = path.join(__dirname, '../../fixtures/test-portrait.jpg');
