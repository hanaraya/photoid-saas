  ...
  for (let y = 0; y < height; y++) {
    for (let x = 0; x < width; x++) {
      ...
      if (dist <= 1) {
        ...
        pixels[idx] = Math.min(255, Math.max(0, Math.round((skinR + variation + brightnessOffset) * shadowFactor)));
        pixels[idx + 1] = Math.min(255, Math.max(0, Math.round((skinG + variation + brightnessOffset) * shadowFactor)));
        pixels[idx + 2] = Math.min(255, Math.max(0, Math.round((skinB + variation + brightnessOffset) * shadowFactor)));
